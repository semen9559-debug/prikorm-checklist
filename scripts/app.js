...
let currentView = (function(){ try{ return localStorage.getItem(VIEW_KEY) || "home"; }catch(e){ return "home"; } })();
let viewReady = false;
...
(function(){
  ...
  var ICONS={
    ...
    "\u{1F45C}":s('<path d="M5 9h14l1 11H4z"/><path d="M8 9V7a4 4 0 0 1 8 0v2"/>'),
...
(function(){
  ...
  ready(function(){
    ...
    function scanPills(){ [].forEach.call(document.querySelectorAll('.chips'), initPill); }
    scanPills();
    ...
    function relayoutPillsIn(v){ requestAnimationFrame(function(){ [].forEach.call(v.querySelectorAll('.chips'), function(gr){ if(gr.__relayout) gr.__relayout(false); }); }); }
...
(function(){
  ...
  ready(function(){
    ...
    function showHub(){ currentView='home'; try{localStorage.setItem(VIEW_KEY,'home');}catch(_){} renderHub(); hub.style.display='block'; window.scrollTo(0,0); syncTabs(); }
